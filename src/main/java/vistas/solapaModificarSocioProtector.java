...
public class solapaModificarSocioProtector extends JInternalFrame{
    ...
    public solapaModificarSocioProtector(String titulo) {
        super(titulo);
        ...
        modificarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(null,"Se ha modificado el Socio Protector");
            }
        });
