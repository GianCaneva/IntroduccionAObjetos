...
//            }
//        });
public class ventanaConsultaConsolidad implements ActionListener{
    ...
    public ventanaConsultaConsolidad(){
        ...
        VentMain.setBackground(Color.red );
    ...
    public static void main(String[] args) {
        ventanaConsultaConsolidad Vent1 = new ventanaConsultaConsolidad() {} ;
    }
