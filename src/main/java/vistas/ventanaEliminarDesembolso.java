...
public class ventanaEliminarDesembolso extends JFrame {
    ...
    public static void main(String[] args) throws Exception {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    vistas.ventanaEliminarDesembolso tester = new vistas.ventanaEliminarDesembolso();
    ...
    public ventanaEliminarDesembolso() {
        ...
        JButton btnNewButton = new JButton("Eliminar Desemboso");
        btnNewButton.setBounds(110, 50, 190, 40);
